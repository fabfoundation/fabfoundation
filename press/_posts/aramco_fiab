---
title: Fab Foundation expands investment in STEM education across the U.S
caption: 
highlight: true
...
img: fflogo.svg
permalink: /media/stem_education_across_the_us_aramco
...
Fab-In-A-Box is powered by seed funding from the Center for Bits and Atoms at MIT and The 
